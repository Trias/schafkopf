...
export default class CallingRulesWithFlatMonteCarloStrategy implements StrategyInterface {
    ...
    chooseCardToPlay(world: GameWorld, cardSet: Card[]): Card {
        ...
        return determineCardToPlayByFlatMonteCarlo(world, cardSet, this.thisPlayer, 10, 10);
    }
