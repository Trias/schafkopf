...
export class CallingRulesWithUctMonteCarloAndHeuristic10k implements StrategyInterface {
    ...
    chooseCardToPlay(world: GameWorld, cardSet: Card[]): Card {
        ...
        return determineCardToPlay(world, this.thisPlayer, cardSet,10,1000, AdvancedHeuristic, generateRandomWorldConsistentWithGameKnowledge);
    }
